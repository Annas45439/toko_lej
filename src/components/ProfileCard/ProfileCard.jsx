      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className={`pc-content pc-avatar-content ${fullImage ? 'pc-full-image' : ''}`}>
              <img className="avatar" src={avatarUrl} alt={`${name} avatar`} loading="lazy" style={avatarStyle}
                onError={e=>{e.target.style.display='none';}} />
              {showUserInfo && (
                <div className="pc-user-info">
                  <div className="pc-user-details">
                    <div className="pc-mini-avatar">
                      <img src={miniAvatarUrl||avatarUrl} alt="mini" loading="lazy" />
                    </div>
